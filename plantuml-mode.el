...
(unless plantuml-kwdList
  ...
  (defvar plantuml-keywords-regexp (concat "^\\s *" (regexp-opt plantuml-keywords 'words) "\\|\\(?:\\*\\(?:-\\(?:\\(?:down\\|left\\|right\\|up\\)?-\\)\\|\\.\\(?:\\(?:down\\|left\\|right\\|up\\)?\\.\\)\\)\\|-\\(?:-\\(?:|>\\|[*>o]\\)\\|down-\\(?:|>\\|[*>o]\\)\\|left-\\(?:|>\\|[*>o]\\)\\|right-\\(?:|>\\|[*>o]\\)\\|up-\\(?:|>\\|[*>o]\\)\\)\\|\\.\\(?:\\.\\(?:|>\\|[*>o]\\)\\|down\\.\\(?:|>\\|[*>o]\\)\\|left\\.\\(?:|>\\|[*>o]\\)\\|right\\.\\(?:|>\\|[*>o]\\)\\|up\\.\\(?:|>\\|[*>o]\\)\\)\\|<\\(?:-\\(?:\\(?:down\\|left\\|right\\|up\\)?-\\)\\|\\.\\(?:\\(?:down\\|left\\|right\\|up\\)?\\.\\)\\||\\(?:-\\(?:\\(?:down\\|left\\|right\\|up\\)?-\\)\\|\\.\\(?:\\(?:down\\|left\\|right\\|up\\)?\\.\\)\\)\\)\\|o\\(?:-\\(?:\\(?:down\\|left\\|right\\|up\\)?-\\)\\|\\.\\(?:\\(?:down\\|left\\|right\\|up\\)?\\.\\)\\)\\)"))
